...
try {
    ...
    $conn->exec(
        "INSERT INTO famosos (codigo, nome) VALUES (1, 'Érico Veríssimo')"
    );
    $conn->exec("INSERT INTO famosos (codigo, nome) VALUES (2, 'John Lenon')");
    $conn->exec(
    ...
    $conn->exec(
        "INSERT INTO famosos (codigo, nome) VALUES (7, 'Mário Quintana')"
    );
